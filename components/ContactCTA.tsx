    ...
    <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            Get a custom plan designed just for you. Professional installation. Simple setup.
          </p>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-2 px-10 py-5 bg-black text-white rounded-full text-lg font-semibold hover:bg-gray-900 transition-all shadow-xl hover:shadow-2xl"
          >
            Get Started
