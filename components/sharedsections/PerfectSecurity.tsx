                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-2 md:gap-3">
                          {/* Animated lock icon with green tint - locks transforms from locked to unlocked */}
                          <motion.div
                            initial={{ scale: 0.8 }}
                            animate={{ 
                              scale: 1,
                          ...
                          >
                            <div className="w-7 h-7 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-green-400/20 to-emerald-500/20 flex items-center justify-center">
                              <svg className="w-4 h-4 md:w-5 md:h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                                {/* Locked state → Unlocked state animation */}
                                {/* Shackle (top part) - animates from closed to open */}
                                <motion.path
                                  strokeLinecap="round" 
                                  strokeLinejoin="round"
                                  initial={{ 
                                    d: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" // Closed lock
                                  }}
                                  animate={{ 
                                    d: "M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" // Open lock
                                  }}
                                  transition={{
                                    duration: 0.5,
                                    ease: [0.22, 1, 0.36, 1],
